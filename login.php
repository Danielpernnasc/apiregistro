...
if(isset($postdata) && !empty($postdata))
{
	...
	$sql = "INSERT INTO cliente_calvo(nome,rua, numero, complemento, bairro, cidade, uf, email, tel, senha, confirma) VALUES ('{$nome}', '{$rua}', '{$complemento}', '{$bairro}', '{$cidade}', '{$uf}', '{$email}', '{$tel}', '{$senha}', '{$confirma}')";
